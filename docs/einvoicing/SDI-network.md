...
Italy einvoicing is one of the examples of a _**clearance model**_ which means validation of the invoice by tax administration before sending it to the buyer.
