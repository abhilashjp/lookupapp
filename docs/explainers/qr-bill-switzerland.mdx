...
5. Further Information Section — This area contains the two data elements “Ultimate Creditor” and “Alternative procedures“. The Ultimate Creditor is the final payee (the person to whom money is paid). Alternative procedures refers to Alternative payment procedures. Upto 90 characters allowed.
...
1. You can follow the Swiss implementation guidelines to create your own QR-bills. 
2. Major ERP players like SAP, Netsuite etc already support QR bill in Switzerland. 
3. If you don’t use one of the major ERP players you can think about using apps like QR-invoice and connect it with your product using Zapier. 

## References used:

1. SIX group newsroom
2. Swiss Implementation guidelines for QR bill
3. FAQs
