...
The Finnish reference number in Finland is used to associate payments with the right customer and the right invoice. It serves the exact same purpose that the [Finnish reference number number](https://lookuptax.com/docs/explainers/Finnish reference number-number-Norway-kundeidentifikasjon) serves in Norway or the [OCR number](https://lookuptax.com/docs/explainers/OCR-number-Sweden) serves in Sweden. 
...
1. Total Number of digits in Finnish reference number - 10
2. Next number in Finnish reference number sequence - 567
