...
Check digit calculation algorithm: Two options — <a href="https://en.wikipedia.org/wiki/Luhn_algorithm" target="_blank">Mod 10 algorithm</a> Mod 10 algorithm or <a href="https://no.wikipedia.org/wiki/MOD11" target="_blank">Mod 11 algorithm</a> Mod 11 algorithm. Use the <a href="https://simplycalc.com/luhn-calculate.php" target="_blank">Mod 10 calculator</a> to validate the KID number that you generate.
