...
Next number: A random input number that will be used as the starting number on the next created invoice to generate the reference number. All counters will work on this random number.
